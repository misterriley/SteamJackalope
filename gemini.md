...
*   **Jaccard Kernel (v4.2)**: Uses Jaccard Similarity (Intersection over Union) for 21 Mechanical Identity Groups (MIGs) and identity match power of **2.0** to ensure structural precision.
