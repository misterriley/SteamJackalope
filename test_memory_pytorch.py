#!/usr/bin/env python3
"""Test memory footprint using PyTorch backend (full model)."""
import os
import sys
import gc
...
def main():
    ...
    # Load PyTorch model (full)
    print("Loading PyTorch model (full)...")
    ...
    print("\n" + "="*60)
    print(f"PYTORCH TOTAL INCREASE: {after_inference - baseline:.2f} MB")
    print("="*60)
