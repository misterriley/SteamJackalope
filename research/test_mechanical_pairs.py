...
pairs = [
    ...
    ("Call of Duty: Black Ops III", "Counter-Strike 2"), # FPS / Shooter
...
# Print found names to ensure we got them
print("Found games:", games_df['name'].tolist())
