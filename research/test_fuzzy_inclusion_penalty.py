...
def eval_game(seed_name, target_name):
    ...
    # 1. Mech Sim (Fuzzy Inclusion with length penalty)
    ...
    abs_diffs = np.abs(profile_sums - seed_sum)
    
    # Add a 5% penalty per unit of length difference
    denominator = min_sums + 0.05 * abs_diffs
...
print("\n--- Evaluating 20 Canonical Pairs (Fuzzy Inclusion Penalty 0.05) ---")
for g1, g2 in pairs:
