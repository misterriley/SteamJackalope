...
def benchmark_lasso_strict(user_id="76561198039155404"):
    ...
    print(f"\n--- Lasso Strict (Normalized) Benchmark ---")
    ...
    for train_idx, test_idx in kf.split(range(N)):
        ...
        strict_scores.append(model.score(X_test_scaled, y[test_idx]))

    print(f"Strict Lasso OOS R2: {np.mean(strict_scores):.4f}")

if __name__ == "__main__":
    benchmark_lasso_strict()
