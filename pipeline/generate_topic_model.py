...
def generate_full_topic_model():
    ...
    summary_path = os.path.join(ROOT_DIR, "data", "production", "topic_summary.csv")
    summary_df.to_csv(summary_path, index=False)
    
    # 7. Save Topic Labels JSON
    labels_path = os.path.join(ROOT_DIR, "data", "production", "topic_labels.json")
