...
def generate_metadata(games_path, reviews_path=None, output_path=None):
    ...
    required_cols = ['appid', 'name', 'genres', 'tags', 'categories', 'supported_languages', 'final_release_date', 'positive', 'negative', 'mature_content', 'date_z', 'pop_z', 'median_playtime', 'playtime_z', 'estimated_playtime', 'release_year', 'difficulty_predicted', 'difficulty_z', 'intercept', 'difficulty_predicted_raw']
