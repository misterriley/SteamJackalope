...
KERNEL_IDENTITY_POWER = 3.0
KERNEL_THEMATIC_CLASH_PENALTY = 0.5
KERNEL_HARD_POLLUTION_PENALTY = 0.1
KERNEL_SOFT_POLLUTION_PENALTY = 0.6
KERNEL_STRONG_NSFW_PENALTY = 0.0001
KERNEL_MATURE_NSFW_PENALTY = 0.01
KERNEL_VR_PENALTY = 0.01
KERNEL_PERSPECTIVE_PENALTY = 0.1
